defmodule TimeManager.Store do
  ...
  # def get_user_by_mail!(email), do: Repo.get_by!(User, email: email)
  ...
  def authentificate_user(email, password) do
    with {:ok, user} <- get_by_mail(email) do
  ...
  defp validate_password(password, encrypted_password) do
    Bcrypt.veryfi_pass(password, encrypted_password)
  end
